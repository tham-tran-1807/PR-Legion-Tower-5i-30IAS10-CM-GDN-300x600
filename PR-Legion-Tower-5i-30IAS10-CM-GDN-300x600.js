...
lib.ssMetadata = [
		{name:"PR_Legion_Tower_5i_30IAS10_CM_GDN_300x600_atlas_1", frames: [[1794,302,50,50],[0,0,300,600],[302,0,300,600],[1190,404,300,309],[1190,0,300,402],[1492,0,300,338],[888,0,300,423],[1794,0,223,300],[1492,340,260,373],[604,0,282,574]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Legion_Tower_5i_30IAS10_CM_GDN_300x600_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.BgIntel = function() {
	this.initialize(ss["PR_Legion_Tower_5i_30IAS10_CM_GDN_300x600_atlas_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.PRLegionTower5i30IAS10CMGDN300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(18,57);
	...
	this.instance_2.setTransform(39,131);
	...
	this.instance_4.setTransform(0,131);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(150).to({_off:false},0).to({_off:true},49).wait(131));
	...
	this.instance_6.setTransform(0,131);
	...
	// Bg_Intel
	this.instance_8 = new lib.BgIntel();
...
// library properties:
lib.properties = {
	id: '942940726409894B91CDEFA0C0245E11',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Legion_Tower_5i_30IAS10_CM_GDN_300x600_atlas_1.png", id:"PR_Legion_Tower_5i_30IAS10_CM_GDN_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['942940726409894B91CDEFA0C0245E11'] = {
